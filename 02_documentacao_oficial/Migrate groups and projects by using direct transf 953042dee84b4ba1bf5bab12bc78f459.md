# Migrate groups and projects by using direct transfer | GitLab Docs
...
1. Cause the import and all items associated with it to fail by running the following command:ruby
